...
class NotificationService : IntentService("NotificationService") {
    ...
    companion object {
        ...
        val CHANNEL_NAME: CharSequence = "yudha channel"
    ...
    private fun showNotification() {
        ...
        val replyAction = NotificationCompat.Action.Builder(
            R.drawable.ic_reply_24_black, replyLabel, getReplyPendingIntent())
    ...
    private fun getReplyPendingIntent(): PendingIntent {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            intent = NotificationBroadcatReceiver.getReplyMessageIntent(this, mNotificationId, mMessageId)
