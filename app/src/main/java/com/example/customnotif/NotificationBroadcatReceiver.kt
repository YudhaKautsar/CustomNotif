...
class NotificationBroadcatReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        fun getReplyMessageIntent(context: Context, notificationId: Int, messageId: Int): Intent {
            val intent = Intent(context, NotificationBroadcatReceiver::class.java)
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (REPLY_ACTION == intent.action) {
            ...
            Toast.makeText(context, "Message ID: $message\nMessage: $message", Toast.LENGTH_SHORT).show()
