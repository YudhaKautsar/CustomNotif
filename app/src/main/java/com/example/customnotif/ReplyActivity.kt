...
class ReplyActivity : AppCompatActivity() {
    ...
    private var nMessageId: Int = 0
    private var nNotifyId: Int = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (REPLY_ACTION == intent.action) {
            nMessageId = intent.getIntExtra(KEY_MESSAGE_ID, 0)
            nNotifyId = intent.getIntExtra(KEY_NOTIFY_ID, 0 )
        }

        button_send.setOnClickListener { sendMessage(nNotifyId, nMessageId) }
    }
    ...
    private fun updateNotification(notifyId: Int) {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_notifications_48_white)
